					...
					<div className="sm:flex-1 ltr:sm:ml-0 ltr:ml-auto sm:rtl:mr-0 rtl:mr-auto flex items-center space-x-1.5 lg:space-x-2 rtl:space-x-reverse dark:text-[#d0d2d6]">
						...
						<div className="dropdown shrink-0 flex">
							<Dropdown
								...
								button={
									<span className={`flex justify-center items-center w-10 h-10 text-center rounded-full object-cover text-base`} style={{ backgroundColor: userInformation.color }}>
										...
										<div className="flex items-center px-4 py-4">
											<div className="truncate">
												<h4 className="text-base">
													{userInformation.name}
													<span className={'text-xs badge badge-outline-' + rolesColor[userInformation.roles_ids[0]] + ' px-1 ml-2'}>{rolesTitle[userInformation.roles_ids[0]]}</span>
												</h4>
