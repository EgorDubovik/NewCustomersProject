				...
				<>
					...
					<div className="w-full sm:w-3/4 m-auto">
						<div className="w-full p-2 md:w-1/2  m-auto grid grid-cols-1 md:grid-cols-2 text-sm">
							<div>
								...
								<div className="flex flex-col gap-2">
									<div>{invoice.job.customer.name}</div>
									<div>{invoice.email}</div>
									<div>{invoice.job.customer.phone}</div>
						...
						<div className="w-full md:w-2/4 m-auto mt-6 text-sm p-2">
							...
							<div className="mt-2">
								{invoice.job.services.map((service: any, index: number) => (
								...
								<div className="total">
									<div className="flex justify-end border-b border-gray-300 py-2">
										...
										<div className="w-1/4 text-right">
											<p>{viewCurrency(invoice.job.total_tax)}</p>
										</div>
									</div>
									<div className="flex justify-end border-b border-gray-300 py-2">
										<div className="w-3/4 text-right">
										...
										<div className="w-1/4 text-right">
											<p>{viewCurrency(invoice.job.total_amount)}</p>
										</div>
									</div>
								</div>
							</div>
