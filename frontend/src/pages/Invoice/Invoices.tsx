...
const Invoice = () => {
	...
	useEffect(() => {
		...
		axiosClient
			.get('invoice?page=' + page + '&limit=' + pageSize)
			.then((res: any) => {
						...
						<DataTable
							...
							columns={[
								...
								},
								{
									...
									render: ({ job }) => (
										<div className="flex items-center font-semibold">
											<Link to={`/customer/${job?.customer?.id}`} className="text-primary underline hover:no-underline">
								...
								},
								{
									accessor: 'date',
									sortable: true,
									render: ({ created_at }) => <div className="font-semibold">{formatDate(created_at, 'MMMM DD YYYY, h:mm A')}</div>,
								},
								{
									accessor: 'amount',
									sortable: true,
